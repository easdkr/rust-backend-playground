...
async fn welcome_handler() -> axum::response::Html<&'static str> {
    axum::response::Html(
        ...
        <head>
            ...
            <title>Rust Backend Playground (DDD)</title>
            <style>
                body {
        ...
        <body>
            <div class="container">
                <span class="tag">DDD Architecture</span>
                <h1>Rust Backend Playground</h1>
                <p>Tokio + Axum + SeaORM(PostgreSQL) + Valkey 기반의 <strong>Domain-Driven Design (DDD)</strong> 아키텍처 구축이 완료되었습니다!</p>
                <p>프로젝트 코드가 Domain, Application, Infrastructure, Presentation 4개의 계층으로 완전하게 분리되어 설계되었습니다.</p>
